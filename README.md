...
Emergency Response Integration – Connects patients with caregivers and hospitals.

Centralized Patient Database – Allows hospitals to access patient medical records quickly.
...
Sensors measure heart rate and blood oxygen levels.

Processing Layer

ESP32 microcontroller processes sensor data and detects abnormal conditions.

Application Layer

Mobile/web application receives health data and sends alerts.
...
LCD Display – Displays real‑time health parameters

Mobile Application – User interface for monitoring and alerts

Cloud Database – Stores patient health data and medical records
